...
const USER_CSS_JS = [
	'styles' => [
		...
		'https://fonts.googleapis.com/css?family=Be+Vietnam+Pro:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic',
		'https://fonts.googleapis.com/css?family=Be+Vietnam+Pro:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic',
		'https://fonts.googleapis.com/css?family=Plus+Jakarta+Sans:regular,600,700&display=swap',
	...
	'scripts' => [
		...
		'assets/js/rating.js',
		'assets/js/element-animation.js',
		'assets/js/slider.js',
		'assets/js/spollers.js',
		'assets/js/dynamic_adapt.js',
		'assets/js/script.js',
	]
];
