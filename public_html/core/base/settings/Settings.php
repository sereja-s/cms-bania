...
class Settings
{
	...
	private $projectTables = [
		'settings' => ['name' => 'Главное на сайте'],
		'phones' => ['name' => 'Телефоны'],
		'advantages' => ['name' => 'Преимущества'],
		'services' => ['name' => 'Наши услуги'],
	...
	private $translate = [
		...
		'img' => ['Изображение'],
		'img_comp' => ['Изображение справа', '(видно на большом экране)'],
		'promo_img' => ['Изображение на втором экране'],
		'visible' => ['Видимость', '(Показывать?)'],
		'menu_position' => ['Позиция в списке', '(Расположение в меню)'],
		'show_top_menu' => ['Показывать в верхнем меню'],
		'title' => ['Заголовок', '(текст на вкладке)'],
